...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        ...
        envVars.put("ARGO_DOMAIN", "xserver.fanhua2.dpdns.org");        // argo固定隧道隧道域名
        ...
        envVars.put("HY2_PORT", "25202");           // hysteria2节点(udp协议)端口，支持多端口可以填写，否则留空
        envVars.put("TUIC_PORT", "24721");          // tuic节点(udp协议)端口，支持多端口可以填写，否则留空
